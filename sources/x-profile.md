...
- Clio 4-day no-commit testing, ElevenLabs hallucinating dates (building in public)
- DeepSeek 7-hour outage (trending reaction)
- ElevenLabs per-language first_message (technical tip)
- Real-time web data quality (engagement question)
- Mistral $830M debt for European AI sovereignty (thread)

From drafts/2026-03-29.md:
- Clio GPS drift and Firecrawl timeouts (building in public)
- Shopify Agentic Storefronts (trending reaction)
- Web Speech API for browser mic (technical tip)
